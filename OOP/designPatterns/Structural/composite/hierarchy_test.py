...
class CompositeElement:
    ...
    def show_details(self):
        ...
        calling their show_details() method.'''
        print(self.position)
...
# Create top-level composite element (General Manager)
topLevelMenu = CompositeElement("GeneralManager")
# Create sub-level composite elements (Managers)
subMenuItem1 = CompositeElement("Manager1")
subMenuItem2 = CompositeElement("Manager2")
# Add managers to the general manager
topLevelMenu.add(subMenuItem1)
topLevelMenu.add(subMenuItem2)

# Create leaf elements (Developers)
...
subMenuItem23 = LeafElement("Developer23")
# Add leaf elements to managers
...
# Remove leaf element 
subMenuItem2.remove(subMenuItem23)

# Print the details of the entire hierarchy
